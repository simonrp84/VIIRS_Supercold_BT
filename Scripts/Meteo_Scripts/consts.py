...
"""Helper to produce the a and b coefficients needed for ECMWF data.

Derived from: https://www.ecmwf.int/en/forecasts/documentation-and-support/137-model-levels
"""
...
def get_avec():
    ...
    return np.array([0.0000000, 2.000365, 3.102241, 4.666084,
                     ...
                     0.0000000, 0.0000000], dtype=np.float64)
...
def get_bvec():
    ...
    return np.array([0.0000000, 0.0000000, 0.0000000, 0.0000000,
                     ...
                     0.99763, 1.0000000], dtype=np.float64)
